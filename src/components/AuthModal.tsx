      ...
      <div
        ...
        <div className="mb-5 flex items-center gap-2 select-none">
          <svg width="28" height="28" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="aml-pg" x1="84" y1="16" x2="18" y2="58" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stopColor="#14BBA6"/>
                <stop offset="100%" stopColor="#2563EB"/>
              </linearGradient>
              <linearGradient id="aml-pgd" x1="84" y1="16" x2="16" y2="66" gradientUnits="userSpaceOnUse">
            ...
            <path d="M84 16 L14 40 L48 56 Z" fill="url(#aml-pg)"/>
            <path d="M84 16 L48 56 L16 64 Z" fill="url(#aml-pgd)" opacity="0.85"/>
